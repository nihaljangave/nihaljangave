...
export default function HomePage() {
  ...
  const codeLines = [
    ...
    { code: "    name: 'Nihal Jangave',", type: 'array-item' },
    { code: "    role: 'Data Engineer',", type: 'array-item' },
    { code: "    bio: 'Building robust data pipelines'", type: 'array-item' },
    { code: '  };', type: 'array-end' },
    { code: '', type: 'blank' },
      ...
      <div className={styles.container}>
        ...
        <div className={styles.infoSection}>
          <h1 className={styles.developerName}>
            Nihal <span className={styles.accentText}>Jangave</span>
          </h1>

          <div className={styles.developerRole}>Data Engineer</div>

          <p className={styles.bio}>
            I build scalable data pipelines and analytics solutions with modern
            technologies. Focused on efficient data processing and insightful user experiences.
          </p>
